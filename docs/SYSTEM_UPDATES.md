...
## 2026-03-06 (Admin UI reorganization + SCUM theme pass)

### เป้าหมาย
- ทำหน้าแอดมินให้เป็นหมวดชัดเจน ใช้งานง่าย และภาพรวมเข้าธีมเกม SCUM มากขึ้น

### สิ่งที่เปลี่ยน
- ปรับโครงหน้าแดชบอร์ด:
  - เพิ่ม section “แผนที่หมวดระบบ” เป็นปุ่มทางลัดไปหมวดหลัก
  - เปลี่ยนเมนูซ้ายให้แยกเป็นกลุ่ม: เศรษฐกิจ / คอมมูนิตี้ / ปฏิบัติการ / คำสั่งเสี่ยง
  - เพิ่มช่องค้นหาในเมนูซ้ายเพื่อ filter หมวดแบบทันที
- ปรับ Data Explorer:
  - แยก dropdown เป็น `optgroup` ตามหมวดข้อมูลเพื่อลดความสับสน
- ปรับโทน UI:
  - ปรับถ้อยคำหัวข้อ/ซับไตเติลให้เป็นแนว “ศูนย์บัญชาการ SCUM”
  - คงธีม `Military Tactical` และ `Neon Cyber` พร้อม responsive behavior เดิม

### ผลกระทบ
- ลดเวลาหาฟอร์มที่ต้องใช้จริง
- หน้าจอเป็นระเบียบขึ้นเมื่อมีฟอร์มจำนวนมาก
- ประสบการณ์ใช้งานสอดคล้องธีมเกมมากขึ้นโดยไม่กระทบ API เดิม

### วิธีทดสอบ
- `npm run check`
- ตรวจฟังก์ชันเมนูหมวด/ค้นหา/ปุ่มทางลัดในหน้า `/admin`
