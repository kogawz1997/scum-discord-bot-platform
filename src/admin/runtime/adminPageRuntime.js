...
function createAdminPageRuntime(options = {}) {
  const {
    ...
    scumItemsDirPath,
    visualAssetsDirPath,
    ownerPrototypeDistDirPath = path.resolve(process.cwd(), 'apps', 'owner-ui-prototype', 'dist'),
  ...
  let cachedOwnerPrototypeHtml = null;
  ...
  let cachedOwnerPrototypeHtmlMtimeMs = 0;
  ...
  function resolveOwnerStitchTemplateName(pathname) {
    ...
    if (rawPath === '/owner/packages/create' || rawPath === '/owner/packages/create/') return '03-owner-package-management.html';
    if (rawPath === '/owner/packages/entitlements' || rawPath === '/owner/packages/entitlements/') return '03-owner-package-management.html';
    ...
    if (rawPath === '/owner/subscriptions/registry' || rawPath === '/owner/subscriptions/registry/') return '05-owner-billing-and-subscriptions.html';
    ...
    if (rawPath === '/owner/billing/recovery' || rawPath === '/owner/billing/recovery/') return '07-owner-billing-overview.html';
    if (rawPath === '/owner/billing/attempts' || rawPath === '/owner/billing/attempts/') return '07-owner-billing-overview.html';
    ...
    if (
      ...
      || rawPath === '/owner/analytics/risk' || rawPath === '/owner/analytics/risk/'
      || rawPath === '/owner/analytics/packages' || rawPath === '/owner/analytics/packages/'
    ...
    if (rawPath === '/owner/recovery/create' || rawPath === '/owner/recovery/create/') return '16-owner-maintenance-and-recovery.html';
    if (rawPath === '/owner/recovery/preview' || rawPath === '/owner/recovery/preview/') return '16-owner-maintenance-and-recovery.html';
    if (rawPath === '/owner/recovery/restore' || rawPath === '/owner/recovery/restore/') return '16-owner-maintenance-and-recovery.html';
    if (rawPath === '/owner/recovery/history' || rawPath === '/owner/recovery/history/') return '16-owner-maintenance-and-recovery.html';
    ...
    if (rawPath === '/owner/settings/admin-users' || rawPath === '/owner/settings/admin-users/') return '19-owner-settings-and-environment.html';
    if (rawPath === '/owner/settings/services' || rawPath === '/owner/settings/services/') return '19-owner-settings-and-environment.html';
    if (rawPath === '/owner/settings/access-policy' || rawPath === '/owner/settings/access-policy/') return '19-owner-settings-and-environment.html';
    if (rawPath === '/owner/settings/portal-policy' || rawPath === '/owner/settings/portal-policy/') return '19-owner-settings-and-environment.html';
    if (rawPath === '/owner/settings/billing-policy' || rawPath === '/owner/settings/billing-policy/') return '19-owner-settings-and-environment.html';
    if (rawPath === '/owner/settings/runtime-policy' || rawPath === '/owner/settings/runtime-policy/') return '19-owner-settings-and-environment.html';
  ...
  function resolveOwnerStitchTitle(pathname, fileName) {
    ...
    if (rawPath === '/owner/packages/create' || rawPath === '/owner/packages/create/') return 'SCUM Owner Plane - Create Package';
    if (rawPath === '/owner/packages/entitlements' || rawPath === '/owner/packages/entitlements/') return 'SCUM Owner Plane - Package Entitlements';
    ...
    if (rawPath === '/owner/subscriptions/registry' || rawPath === '/owner/subscriptions/registry/') return 'SCUM Owner Plane - Subscription Registry';
    ...
    if (rawPath === '/owner/billing/recovery' || rawPath === '/owner/billing/recovery/') return 'SCUM Owner Plane - Billing Recovery';
    if (rawPath === '/owner/billing/attempts' || rawPath === '/owner/billing/attempts/') return 'SCUM Owner Plane - Payment Attempts';
    ...
    if (rawPath === '/owner/analytics/risk' || rawPath === '/owner/analytics/risk/') return 'SCUM Owner Plane - Risk Queue';
    if (rawPath === '/owner/analytics/packages' || rawPath === '/owner/analytics/packages/') return 'SCUM Owner Plane - Package Usage';
    ...
    if (rawPath === '/owner/recovery/create' || rawPath === '/owner/recovery/create/') return 'SCUM Owner Plane - Create Backup';
    if (rawPath === '/owner/recovery/preview' || rawPath === '/owner/recovery/preview/') return 'SCUM Owner Plane - Restore Preview';
    if (rawPath === '/owner/recovery/restore' || rawPath === '/owner/recovery/restore/') return 'SCUM Owner Plane - Restore Apply';
    if (rawPath === '/owner/recovery/history' || rawPath === '/owner/recovery/history/') return 'SCUM Owner Plane - Recovery History';
    ...
    if (rawPath === '/owner/settings/admin-users' || rawPath === '/owner/settings/admin-users/') return 'SCUM Owner Plane - Admin Users';
    if (rawPath === '/owner/settings/services' || rawPath === '/owner/settings/services/') return 'SCUM Owner Plane - Managed Services';
    if (rawPath === '/owner/settings/access-policy' || rawPath === '/owner/settings/access-policy/') return 'SCUM Owner Plane - Access Policy';
    if (rawPath === '/owner/settings/portal-policy' || rawPath === '/owner/settings/portal-policy/') return 'SCUM Owner Plane - Portal Policy';
    if (rawPath === '/owner/settings/billing-policy' || rawPath === '/owner/settings/billing-policy/') return 'SCUM Owner Plane - Billing Policy';
    if (rawPath === '/owner/settings/runtime-policy' || rawPath === '/owner/settings/runtime-policy/') return 'SCUM Owner Plane - Runtime Policy';
...
'<link rel="stylesheet" href="/admin/assets/owner-stitch-polish.css?v=20260418-owner-stitch-polish-36">',
...
'<script src="/admin/assets/owner-v4-app.js?v=20260415-owner-v4-app-9"></script>',
    '<script src="/admin/assets/owner-stitch-bridge.js?v=20260418-owner-stitch-51"></script>',
'<script src="/admin/assets/owner-stitch-live.js?v=20260418-owner-stitch-live-46"></script>',
    ].join('');
    return [
      '<!doctype html>',
      '<html lang="en">',
  ...
  async function tryServeOwnerPrototypeStaticAsset(req, res, pathname) {
    if (String(req.method || '').toUpperCase() !== 'GET') return false;
    if (!String(pathname || '').startsWith('/assets/')) return false;

    let relativeName = '';
    try {
      relativeName = decodeURIComponent(String(pathname || '').slice('/assets/'.length));
    } catch {
      return false;
    }
    if (!relativeName || relativeName.includes('\\') || relativeName.includes('..')) {
    ...
    const prototypeAssetsDirPath = path.resolve(ownerPrototypeDistDirPath, 'assets');
    const absPath = path.resolve(prototypeAssetsDirPath, relativeName);
    if (!absPath.startsWith(prototypeAssetsDirPath)) {
      return false;
    }
  ...
  function getOwnerPrototypeHtml() {
    const filePath = path.resolve(ownerPrototypeDistDirPath, 'index.html');
    try {
      const result = readHtmlWithMtime(cachedOwnerPrototypeHtml, cachedOwnerPrototypeHtmlMtimeMs, filePath);
      cachedOwnerPrototypeHtml = result.html;
      cachedOwnerPrototypeHtmlMtimeMs = result.mtimeMs;
      return cachedOwnerPrototypeHtml;
    } catch {
      return '';
    }
  }
  ...
  return {
    ...
    tryServeOwnerPrototypeStaticAsset,
    tryServeStaticScumIcon,
    getDashboardHtml,
    getOwnerConsoleHtml,
    getOwnerSurfaceHtml,
    getOwnerPrototypeHtml,
