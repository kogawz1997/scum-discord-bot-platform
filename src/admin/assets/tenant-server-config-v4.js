  ...
  const PORTAL_ENV_BASIC_GROUPS = [
    {
      ...
      fields: [
        ...
        },
        {
          key: 'siteName',
          label: 'Site name',
          description: 'Shown on public server pages and the player portal header for this tenant.',
          type: 'text',
          defaultValue: '',
        },
        {
          ...
          description: 'Short supporting copy used on player and public server surfaces.',
          type: 'text',
          defaultValue: '',
        },
        {
          key: 'logoUrl',
          label: 'Logo URL',
          description: 'HTTPS or root-relative image used for the player/public brand mark.',
          type: 'text',
          defaultValue: '',
        },
        {
          key: 'bannerUrl',
          label: 'Banner URL',
          description: 'HTTPS or root-relative image used for the player/public hero banner.',
          type: 'text',
          defaultValue: '',
        },
        {
          key: 'primaryColor',
          label: 'Primary color',
          description: 'Hex color token such as #3366ff used for branding accents.',
          type: 'text',
          defaultValue: '',
        },
        {
          key: 'accentColor',
          label: 'Accent color',
          description: 'Secondary hex color token used for player/public highlights.',
          type: 'text',
          defaultValue: '',
        },
      ],
