...
function routeVisualPresentation(routeKey) {
  ...
  if (key === 'analytics' || key === 'analytics-risk' || key === 'analytics-packages' || key === 'automation') {
    return {
      visual: 'analytics',
...
function routeActionLinks(pathname, routeKey) {
  switch (routeKey) {
    ...
    case 'packages':
      return [
        actionLink('Create Package', '/owner/packages/create', 'primary'),
        actionLink('Entitlements', '/owner/packages/entitlements'),
        actionLink('Subscriptions', '/owner/subscriptions'),
        actionLink('Billing', '/owner/billing'),
      ];
    case 'packages-create':
      return [
        actionLink('Package Catalog', '/owner/packages'),
        actionLink('Entitlements', '/owner/packages/entitlements', 'primary'),
      ];
    case 'packages-entitlements':
      return [
        actionLink('Package Catalog', '/owner/packages'),
        actionLink('Create Package', '/owner/packages/create'),
      ];
    case 'package-detail':
      return [
        actionLink('Packages', '/owner/packages'),
    ...
    case 'subscriptions':
      return [
        ...
        actionLink('Subscription Registry', '/owner/subscriptions/registry', 'primary'),
        actionLink('Open Payment Attempt', '/owner/billing/attempt'),
      ];
    case 'subscriptions-registry':
      return [
        actionLink('Renewal Queue', '/owner/subscriptions'),
        actionLink('Billing Overview', '/owner/billing', 'primary'),
      ];
    ...
    case 'billing-attempts':
      return [
        actionLink('Billing Overview', '/owner/billing'),
        actionLink('Billing Recovery', '/owner/billing/recovery', 'primary'),
      ];
    case 'invoice-detail':
    case 'attempt-detail':
      return [
    ...
    case 'analytics':
      return [
        actionLink('Risk Queue', '/owner/analytics/risk', 'primary'),
        actionLink('Package Usage', '/owner/analytics/packages'),
        actionLink('Jobs', '/owner/jobs'),
        actionLink('Automation', '/owner/automation'),
      ];
    case 'analytics-risk':
      return [
        actionLink('Analytics Overview', '/owner/analytics/overview'),
        actionLink('Support', '/owner/support', 'primary'),
      ];
    case 'analytics-packages':
      return [
        actionLink('Analytics Overview', '/owner/analytics/overview'),
        actionLink('Packages', '/owner/packages', 'primary'),
      ];
    case 'automation':
      return [
        actionLink('Analytics Overview', '/owner/analytics/overview'),
    ...
    case 'recovery':
      return [
        actionLink('Create Backup', '/owner/recovery/create', 'primary'),
        actionLink('Restore Preview', '/owner/recovery/preview'),
        actionLink('Restore Apply', '/owner/recovery/restore'),
        actionLink('Recovery History', '/owner/recovery/history'),
        actionLink('Backup Detail', '/owner/recovery/tenant-backup'),
        actionLink('Diagnostics', '/owner/diagnostics'),
      ];
    case 'recovery-create':
      return [
        actionLink('Recovery Overview', '/owner/recovery/overview'),
        actionLink('Restore Preview', '/owner/recovery/preview', 'primary'),
      ];
    case 'recovery-preview':
      return [
        actionLink('Recovery Overview', '/owner/recovery/overview'),
        actionLink('Apply Restore', '/owner/recovery/restore', 'primary'),
      ];
    case 'recovery-restore':
      return [
        actionLink('Recovery Overview', '/owner/recovery/overview'),
        actionLink('Recovery History', '/owner/recovery/history', 'primary'),
      ];
